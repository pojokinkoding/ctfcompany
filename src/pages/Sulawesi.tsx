    ...
    <main className="pt-[150px] pb-24 font-sans text-brand-green">
      <section className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 mb-20">
        ...
        <div className="w-full aspect-[4.5/1] rounded-xl sm:rounded-2xl overflow-hidden shadow-sm mb-10">
          <img 
            src={`${import.meta.env.BASE_URL}product5.png`}
            alt="Sulawesi Banner"
            className="w-full h-full object-cover"
            referrerPolicy="no-referrer"
            onError={(e) => {
              (e.target as HTMLImageElement).src = "https://placehold.co/1200x300/4a5d4e/ffffff?text=Sulawesi+Textile+Banner";
            }}
          />
        </div>
        ...
        <div className="w-full mb-16 flex justify-center">
          <img 
            src={`${import.meta.env.BASE_URL}sulawesi 1 (1).png`}
            alt="Map of Indonesia with pin on Sulawesi"
            className="w-full max-w-[1000px] h-auto object-contain"
            referrerPolicy="no-referrer"
            onError={(e) => {
              (e.target as HTMLImageElement).src = "https://placehold.co/1000x500/e0e5e1/4a5d4e?text=Map+of+Indonesia+with+Pin+on+Sulawesi";
            }}
          />
        </div>
        ...
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-12 lg:gap-24">
          ...
          {/* Column 1: Toraja Washed */}
          <div>
            <h2 className="font-display text-[20px] md:text-[24px] font-bold text-brand-green mb-4 tracking-wide">Toraja Washed</h2>
            <ul className="space-y-3 text-[13px] md:text-[14px] font-medium text-brand-green/90">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-bold">Origin:</span> Toraja Minanga, Sulawesi
                </div>
              </li>
              <li className="flex items-start gap-3">
                <ClipboardList className="w-[16px] h-[16px] shrink-0 mt-0.5 text-brand-green" />
                <div>
                  <span className="font-bold">Highlight Note:</span><br/>Herbs, Lime, Caramel, Medium Body
                </div>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-bold">Post process:</span> Washed Dryhull
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Ruler className="w-[16px] h-[16px] shrink-0 mt-0.5 text-brand-green" />
                <div>
                  <span className="font-bold">Altitude:</span> 1500-1600
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Leaf className="w-[16px] h-[16px] shrink-0 mt-0.5 text-brand-green" />
                <div>
                  <span className="font-bold">Variety:</span> Sigararutang, Lini-s, Typica
                </div>
              </li>
              <li className="flex items-start gap-3">
          ...
          {/* Column 2: Toraja Natural */}
          <div>
            <h2 className="font-display text-[20px] md:text-[24px] font-bold text-brand-green mb-4 tracking-wide">Toraja Natural</h2>
            <ul className="space-y-3 text-[13px] md:text-[14px] font-medium text-brand-green/90">
              <li className="flex items-start gap-3">
                <Globe className="w-[16px] h-[16px] shrink-0 mt-0.5 text-brand-green" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <ClipboardList className="w-[16px] h-[16px] shrink-0 mt-0.5 text-brand-green" />
                <div>
                  <span className="font-bold">Highlight Note:</span><br/>Cardamon, Choco Caramel, Medium Body
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Award className="w-[16px] h-[16px] shrink-0 mt-0.5 text-brand-green" />
