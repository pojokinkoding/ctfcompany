  ...
  return (
    <main className="pt-[150px] pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-12">
        ...
        >
          <img
            src={`${import.meta.env.BASE_URL}home1.png`}
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl overflow-hidden aspect-[21/9] shadow-lg"
          >
            <img
              src={`${import.meta.env.BASE_URL}welcome1.png`}
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        <div className="grid md:grid-cols-2 gap-6">
          <Link to="/about" className="block">
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}about1.png`}
          ...
          <Link to="/product" className="block">
            ...
            >
              <img
                src={`${import.meta.env.BASE_URL}product1.png`}
